		...
		<div class="modal__container background-dark" role="dialog" aria-modal="true" aria-labelledby="notifications-label" data-scroll-lock-scrollable>
			...
			<nav id="notifications-nav" class="nav nav--notifications nav--notifications--has-items notifications no-print">
				...
				<div class="notifications__group">
					...
					<?php
					include '../parts/notifications/notification-important-variation-1.php';
					include '../parts/notifications/notification-important-variation-2.php';
					?>
				...
				<div class="notifications__group">
					...
					<?php
					include '../parts/notifications/notification-unread.php';
					include '../parts/notifications/notification-read.php';
					?>
					
				</div>
				<button class="button button--outlined-white button--centered button--wide">View all notifications</button>
			</nav>
		</div>
	</div>				
</div>