...
<div id="programme-courses" class="programme-courses">
	...
	<div class="content-block background-grey">
		...
		<div id="courses" class="tab-content current course-list">
			
			<?php
			// Get the alert that shows the user has failed the course.
			include '../parts/programme-details/alert-failed.php';
