<?php
/**
 * Content block - discounts - expired
 * @since initial
 */
	...
	<div class="block__inner">
		<div class="block__content">
			<div class="js-accordion accordion">
				<div class="js-accordion-title accordion__title"><a href="#"><h3>Discounts (expired code)</h3></a></div>
				<div>
							...
							<div class="form__block">
								<div class="form__element form__element--code form__element--invalid">
									<div class="form__element__fields">
										...
										<input id="discount-code" type="text" value="EXPIRED">
										<input type="submit" value="Verify code" class="no-print">
									</div>
									<div class="form__validation">
										<p>Sorry, the code you entered has expired.</p>
									</div>
								</div>
							</div>
						</form>
