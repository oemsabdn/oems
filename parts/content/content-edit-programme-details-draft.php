<?php
/**
 * Content - Programme Details - draft
 * @since Sprint 18
 */
?>

<main id="main" class="course-details page-content edit-mode edit-mode--is-draft">
	...
	<div id="overview" class="js-page-nav content-section content-section--first">
		...
		include '../parts/blocks/checklist/edit/checklist-edit.php';
	...
	<div id="what" class="js-page-nav content-section">
		...
		include '../parts/blocks/multi/edit/multi-vertical-one-not-published.php';
		include '../parts/blocks/accordion/edit/accordion-not-published.php';
		include '../parts/blocks/accordion/edit/accordion-edit.php';
	...
	<div id="fees" class="js-page-nav content-section">
		<div class="block block--is-section-header not-editable" tabindex="0">
			<div class="block__inner">
				<div class="block__content">
	...
	<div id="entry" class="js-page-nav content-section">
		<div class="block block--is-section-header not-published" data-block-id="1019" tabindex="0">
