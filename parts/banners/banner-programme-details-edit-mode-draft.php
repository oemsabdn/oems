<?php
/**
 * Banner - Programme Details - edit mode - draft
 * @since Sprint 18
 */
				...
				<div class="row">
					<div class="s12 m6 l6 col">
						<div class="banner__content">
							...
							<h1>Edit mode - draft template</h1>
							<p>A draft page in edit mode. A mixture of published and not published blocks are shown.</p>
						</div>
					</div>
				</div>
			</div>
