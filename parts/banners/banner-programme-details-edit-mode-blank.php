<?php
/**
 * Banner - Programme Details - edit mode - blank
 * @since Sprint 18
 */
				...
				<div class="row">
					<div class="s12 m6 l6 col">
						<div class="banner__content">
							...
							<h1>Edit mode - blank template</h1>
							<p>The blank template used on page setup. Only heading blocks are shown and are not published.</p>
						</div>
					</div>
				</div>
			</div>
